...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-gray-300 pt-16 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <a href="https://wa.me/94723303946" target="_blank" rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl flex items-center justify-center transition-all hover:scale-110"
